         ...
         <ul class="navbar-nav flex-row align-items-center ms-md-auto">
                     ...
                     <div class="dropdown-shortcuts-list scrollable-container">
                         ...
                         <div class="row row-bordered overflow-visible g-0">
                             <div class="dropdown-shortcuts-item col">
                                 ...
                                 <a href="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/html/vertical-menu-template/index.html"
             ...
             <li class="nav-item navbar-dropdown dropdown-user dropdown">
                 ...
                 <ul class="dropdown-menu dropdown-menu-end">
                     ...
                     <li>
                         <a class="dropdown-item"
                             href="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/html/vertical-menu-template/pages-account-settings-billing.html">
                     ...
                     <li>
                         <a class="dropdown-item"
                             href="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/html/vertical-menu-template/pages-pricing.html">
                             <i class="icon-base bx bx-dollar icon-md me-3"></i><span>Pricing</span>
                         </a>
                     </li>
                     <li>
                         <a class="dropdown-item"
                             href="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/html/vertical-menu-template/pages-faq.html">
                     ...
                     <li>
                         <a class="dropdown-item" href="{{ url('/sign-out') }}"
                             onclick="event.preventDefault();document.getElementById('adminSignOutForm').submit();"> <i
                                 class="icon-base bx bx-power-off icon-md me-3"></i><span>Sign
                                 Out</span>
                         </a>
                         <form id="adminSignOutForm" action="{{ url('/sign-out') }}" method="POST" class="d-none">
                             @csrf
                         </form>
                     </li>
                 </ul>
