...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="layout-wide  customizer-hide" dir="ltr"
    data-skin="default" data-assets-path="{{ asset('assets/admin') . '/' }}" data-template="vertical-menu-template"
    data-bs-theme="light">
               ...
               @include('partials.admin.message')
                ...
                <div class="card px-sm-6 px-0">
                    <div class="card-body">
                        ...
                        <form id="formAuthentication_001" class="mb-6" action="{{ url('admin/sign-up/store') }}"
