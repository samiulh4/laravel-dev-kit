...
<!-- Mirrored from demos.themeselection.com/sneat-bootstrap-html-admin-template/html/vertical-menu-template/pages-misc-not-authorized.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Jun 2025 19:39:40 GMT -->
<head>
    <meta charset="utf-8" />
    ...
    <!-- Page CSS -->
    <!-- Page -->
  <link rel="stylesheet" href="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/assets/vendor/css/pages/page-misc.css" />
  ...
  <div class="container-xxl container-p-y">
    <div class="misc-wrapper">
      ...
      <a href="{{ url('admin/sign-in') }}" class="btn btn-primary">Back to home</a>
      <div class="mt-6">
        <img src="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/assets/img/illustrations/girl-with-laptop-light.png" alt="page-misc-not-authorized-light" width="500" class="img-fluid" data-app-light-img="illustrations/girl-with-laptop-light.png" data-app-dark-img="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/html/vertical-menu-template/illustrations/girl-with-laptop-dark.png" />
      </div>
    </div>
  </div>
  <!-- /Not Authorized -->
